...
struct GeminiRealtimeInput {
    // PATCH(joi): `mediaChunks` is deprecated and rejected by current Live models
    // (gemini-3.1-flash-live-preview closes with "media_chunks is deprecated"). The API now takes a
